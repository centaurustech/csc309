        ...
        <div class="container">            
            <h1 class="logo pull-left">
                <a class="scrollto" href="#promo">
                    <span class="logo-title">CommunityFund</span>
                </a>
            </h1><!--//logo-->              
            <nav id="main-nav" class="main-nav navbar-right" role="navigation">
                ...
                <div class="navbar-collapse collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"><a class="scrollto" href="#">Sign In</a></li>
...
the project helping it reaching a specific goal set by the initiators.</p>
    ...
    <section id="contact" class="contact section has-pattern">
        <div class="container">
            <div class="contact-inner">
                ...
                <p class="intro text-center"> EMAIL FORM HERE YO</p>
    ...
    <footer class="footer">
        <div class="container text-center">
            <p>Designed by <a href="#">OG Web Dev</a> </p>
        </div><!--//container-->
    </footer><!--//footer-->
